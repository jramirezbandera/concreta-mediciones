...
import { type CostLocation, CostOverride } from '../../domain/CostOverride';
...
import { type Concept } from '../../domain/types/Concept';
import { evaluatePartial } from '../../utils/expressionEvaluator';
import { type BC3ParseStore } from '../BC3ParseStore';
 ...
 */
export function parsePerformance(value: string | undefined): number | undefined {
